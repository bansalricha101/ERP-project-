...
<table width="100%" align="center" cellpadding="4" cellspacing="0" class="zebra zebra2">
 <tr>
<th>ID</th>
<th>Subject</th>
<th>Message</th>
...
<?php 
error_reporting(0); 
$sql = "select * from query where username ='$adi' ";
      $result = $conn->query($sql);
       if ($result->num_rows > 0) { // if one or more rows are returned do following
            while($ro = $result->fetch_assoc()){    
                ...
                echo "<tr><td>".$ro["id"]."</td><td>".$ro["subject"]."</td><td>".$ro["msg"]."</td><<td style='color:green;'><b>".$ro["status"]."</b></td>";
                echo "</tr>";
            }
        }
    ?>
