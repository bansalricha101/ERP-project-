       ...
       <br>
			...
			<!--/sidebar-menu-->
				<div class="sidebar-menu">
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="staff.html"> <span style="color:white; font-size: 1.6em; font-family: Brush Script MT">ERP MODULE</span>
